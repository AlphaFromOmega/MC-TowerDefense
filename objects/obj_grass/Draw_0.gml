...
image_blend = obj_level.biome_colour;
draw_sprite_ext(sprite_index, image_index, x, sprite_y + (16 - steps)/2, 1, 1, 0, image_blend, image_alpha);
draw_sprite_ext(spr_shadow, shadows, x, sprite_y + (16 - steps)/2, 1, 1, 0, c_white, image_alpha/2);
if (b_display)
{
	draw_sprite_part_ext(side, image_index, 0, 16 - steps, 16, steps, bbox_left, sprite_y + sprite_bottom + 1 + (16 - steps)/2, 1, 0.5, c_white, image_alpha);
	draw_sprite_part_ext(side_overlay, image_index, 0, 16 - steps, 16, steps, bbox_left, sprite_y + sprite_bottom + 1 + (16 - steps)/2, 1, 0.5, image_blend, image_alpha);
